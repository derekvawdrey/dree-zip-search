...
const DreeProMapMarker = (dreePro) => {
    const markerStyle = {
        position: 'absolute',
        width: '32px',
        height: '32px',
    ...
    return (
        ...
        <svg viewBox="-4 0 36 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" height="32px" width="32px">
...
export default DreeProMapMarker;